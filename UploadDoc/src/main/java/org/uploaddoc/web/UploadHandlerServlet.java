...
@WebServlet(name = "UploadHandlerServlet", urlPatterns = {"/fileupload"})
@MultipartConfig
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (username != null) { 
            ...
            try {
                ...
                PreparedStatement pstmt = conn.prepareStatement("INSERT INTO documents (username, reg1File, contentreg1, ins1File, contentins1, reg2File, contentreg2, ins2File, contentins2) VALUES (?, ?, ?, ?, ?, ? ,? , ?, ?)");
