...
public class User {
	...
	public User(int id, String username, String password, int propertycode, String propertyname, String unit,
			...
			String registrationexpiredate2,  String insuranceexpiredate2, String status2, String emailid) {
	...
	public User(String username, String password, int propertycode, String propertyname, String unit, String resident,
