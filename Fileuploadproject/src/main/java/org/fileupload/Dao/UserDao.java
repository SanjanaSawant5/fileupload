...
import org.fileupload.bean.User;
...
public class UserDao {
	...
	public User callStoredProcedure(String username, String password) {
		User user = null;
		try {
			PreparedStatement pstmt = con.prepareStatement("SELECT * FROM demo WHERE username = ? AND password = ?");
